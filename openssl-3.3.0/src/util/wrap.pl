...
BEGIN {
    ...
    require 'C:/Users/Jeyadevan/Documents/Visual Studio 2022/Projects/Login-Page-Using-SHA256/openssl-3.3.0/src/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Users/Jeyadevan/Documents/Visual Studio 2022/Projects/Login-Page-Using-SHA256/openssl-3.3.0/src/test/fips-and-base.cnf';
    shift;
